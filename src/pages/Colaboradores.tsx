...
export const Colaboradores = () => {
  ...
  // 🔑 força remount da tabela quando trocar o filtro de departamento
  ...
  // handler do filtro de departamento (com blur para fechar o menu imediatamente)
  ...
  // ⬇️ Exportar CSV do resultado filtrado (agora com Nível)
  const exportCsv = () => {
  ...
  return (
    <LocalErrorBoundary>
      <Box sx={{ p: 2, width: "100%" }}>
        ...
        {/* Tabela */}
        <Paper key={tableKey} sx={{ width: "100%", p: 0 }}>
                  ...
                  filtrados.map((colab, index) => {
                    ...
                    return (
                      <TableRow key={id ?? `row-${index}`} hover>
                        ...
                        {/* ✅ Status: força string antes de trim */}
                        <TableCell>
                          {(() => {
